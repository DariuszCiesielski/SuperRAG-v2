...
const DropdownMenuContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Content> & { style?: React.CSSProperties }
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:[background-color:var(--bg-accent)] [color:var(--text-primary)]",
      inset && "pl-8",
      className
    )}
    {...props}
